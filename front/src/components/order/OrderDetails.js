        ...
        <Fragment>
          <div className="registro my-5">
            <div className="registro-form-container shadow">
              ...
              <h3 className="my-5">Pedido # {order._id}</h3>
              ...
              <div className="cart-item my-1">
                {items && items.map(item => (
                  <div key={item.product} className="row my-5">
                    ...
                    <div className="col-4 col-lg-3 mt-4 mt-lg-0 m-1">
              ...
              <div className='button-cart'>
                <button className="registro-button-cart comprar" onClick={() => navigate(-1)}>Atrás</button>
              </div>
