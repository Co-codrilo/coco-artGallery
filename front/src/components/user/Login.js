          ...
          <div className="login">
            <div className="login-form-container">
              ...
              <form className="login-form" onSubmit={submitHandler}>
                ...
                <Link to={'/password/forgot'} className='mb-2'><span className='login-register'>¿Olvidó su contraseña?</span></Link>
                {/* Olvido de contraseña */}

                <input type="submit" className="login-button" />
              </form>

              <span className='login-register'>¿Usuario nuevo? <Link to={'/register'}>Resgistrar</Link></span>
