        ...
        <div className="col-12 col-lg-3 my-4">
          <div id="order_summary">
            ...
            <div className='button-cart'>
              <button id="checkout_btn" className="registro-button-cart comprar" onClick={processToPayment}>Continuar con el pago</button>
            </div>
          </div>
        </div>

      </div>
      <div className="footer-registro-form mb-5">
